...
Exit Function
Error:
    Assert , "ChecksumModule.LShift", Err.Number, Err.Description
    Resume Next
End Function
...
Exit Function
Error:
    Assert , "ChecksumModule.RShift", Err.Number, Err.Description
    Resume Next
End Function
...
Exit Function
Error:
    Assert , "ChecksumModule.AddUnsigned", Err.Number, Err.Description
    Resume Next
End Function
...
Exit Function
Error:
    Assert , "ChecksumModule.ch", Err.Number, Err.Description
    Resume Next
End Function
...
Exit Function
Error:
    Assert , "ChecksumModule.Maj", Err.Number, Err.Description
    Resume Next
End Function
...
Exit Function
Error:
    Assert , "ChecksumModule.r", Err.Number, Err.Description
    Resume Next
End Function
...
Exit Function
Error:
    Assert , "ChecksumModule.Sigma0", Err.Number, Err.Description
    Resume Next
End Function
...
Exit Function
Error:
    Assert , "ChecksumModule.Sigma1", Err.Number, Err.Description
    Resume Next
End Function
...
Exit Function
Error:
    Assert , "ChecksumModule.Gamma0", Err.Number, Err.Description
    Resume Next
End Function
...
Exit Function
Error:
    Assert , "ChecksumModule.Gamma1", Err.Number, Err.Description
    Resume Next
End Function
...
Exit Function
Error:
    Assert , "ChecksumModule.ConvertToWordArray", Err.Number, Err.Description
    Resume Next
End Function
...
Exit Function
Error:
    Assert , "ChecksumModule.SHA256", Err.Number, Err.Description
    Resume Next
End Function
...
Exit Function
Error:
    Assert , "ChecksumModule.CRC32", Err.Number, Err.Description
    Resume Next
End Function

'Public Function CS36(sText As String) As String
'Const Chars = "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789"
'Const HexChars = "0123456789ABCDEF"
'Dim s As Long, i As Long
'Dim SHA As String
'Dim SHAChunk(1 To 16) As Long
'Dim Chunk() As String
'Dim C36() As Long
'Dim Tmp As String
'    ReDim Chunk(1 To 16)
'    SHA = SHA256(sText)
'    For s = 4 To 64 Step 4
'        Tmp = Mid(SHA, s - 4 + 1, 4)
'        SHAChunk(s \ 4) = CLng("&H" & Tmp)
'        ConvertBase10ToX SHAChunk(s \ 4), 36, C36
'        For i = 1 To UBound(C36)
'            Chunk(s \ 4) = Chunk(s \ 4) & Mid(Chars, C36(i) + 1, 1)
'        Next i
'    Next s
'    Tmp = ""
'    For i = 1 To 16
...
'   Next i
'    For i = 1 To 5
'        CS36 = CS36 & Mid(Tmp, 5 * i, 5)
'        If i <> 5 Then CS36 = CS36 & "-"
'    Next i
'    ReDim Chunk(5)
'End Function
...
Const HexChars = "0123456789ABCDEF"
    ...
    ReDim Chunk(1 To 16)
    SHA = SHA256(sText)
    For s = 5 To 64 Step 5
        tmp = Mid(SHA, s - 5 + 1, 5)
        SHAChunk(s \ 5) = CLng("&H" & tmp)
        ConvertBase10ToX SHAChunk(s \ 5), 36, C36
        For i = 1 To UBound(C36)
            Chunk(s \ 5) = Chunk(s \ 5) & Mid(Chars, C36(i) + 1, 1)
        Next i
    Next s
    tmp = ""
    For i = 1 To 16
    ...
    Next i
    For i = 0 To 4
        CS36 = CS36 & Mid(tmp, 5 * i + 1, 5)
        If i <> 4 Then CS36 = CS36 & "-"
    Next i
    
Exit Function
Error:
    Assert , "ChecksumModule.CS36", Err.Number, Err.Description
    Resume Next
End Function
